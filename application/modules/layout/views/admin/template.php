...
<head>
  ...
  <title><?= isset($title) ? $title : 'Tidak ada title' ?> | Laptopku</title>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?= site_url('assets/admin/') ?>plugins/summernote/summernote-bs4.css">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark"><?= isset($judul) ? $judul : 'Tidak ada judul' ?></h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
      ...
      <section class="content">
        <div class="container-fluid">
          <?= isset($content) ? $content : 'Tidak ada isi' ?>
        </div><!-- /.container-fluid -->
      </section>
      <!-- /.content -->
    </div>
