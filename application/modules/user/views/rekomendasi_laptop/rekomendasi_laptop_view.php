            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="isi()" value="<?= $this->input->post('ram') ?>" class="form-control" name="ram" id="ram" style="width:100% !important" placeholder="Masukkkan Nilai 0-100">
                    </div>
                    <div class="form-group">
                        <label for="hdd">Penyimpanan internal<br> (*presentase)</label>
                        <input type="text" onkeyup="isi()" value="<?= $this->input->post('hdd') ?>" class="form-control" name="hdd" id="hdd" style="width:100% !important" placeholder="Masukkkan Nilai 0-100">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="isi()" value="<?= $this->input->post('vga') ?>" class="form-control" name="vga" id="vga" style="width:100% !important" placeholder="Masukkkan Nilai 0-100">
                    </div>
